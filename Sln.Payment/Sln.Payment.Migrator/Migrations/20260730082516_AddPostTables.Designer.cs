...
namespace Sln.Payment.Migrator.Migrations
{
    ...
    [Migration("20260730082516_AddPostTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Sln.Payment.Data.Entities.Comment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.Property<Guid?>("ReplyToAccountId")
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Sln.Payment.Data.Entities.Post", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Sln.Payment.Data.Entities.PostLike", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("Sln.Payment.Data.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("Sln.Payment.Data.Entities.Post", "Post")
                        .WithMany()
                        .HasForeignKey("PostId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Sln.Payment.Data.Entities.Account", "ReplyToAccount")
                        .WithMany()
