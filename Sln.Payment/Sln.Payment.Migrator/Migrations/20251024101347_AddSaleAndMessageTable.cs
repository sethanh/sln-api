...
{
    /// <inheritdoc />
    public partial class AddSaleAndMessageTable : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubTotalDetail = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    ...
                    CancelNote = table.Column<string>(type: "longtext", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Type = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ConversationAccount", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ConversationAccount_Account_AccountId",
                        column: x => x.AccountId,
                        principalTable: "Account",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ConversationAccount_Conversation_ConversationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ConversationAccount_AccountId",
                table: "ConversationAccount",
                column: "AccountId");

            migrationBuilder.CreateIndex(
                name: "IX_ConversationAccount_ConversationId",
                table: "ConversationAccount",
